...
* Your task is to create a Python script that analyzes the records to calculate each of the following:
  ...
  * The total number of months included in the dataset (count the months)

  * The net total amount of "Profit/Losses" over the entire period (total of profit/losses)

  * The average of the changes in "Profit/Losses" over the entire period (average Profit/Losses over total)
